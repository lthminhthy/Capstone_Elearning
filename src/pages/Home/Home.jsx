        ...
        <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
          <div className="max-w-xl text-center sm:text-left">
            ...
            <div className="mt-8 mb-5 flex flex-wrap gap-4 text-center">
              ...
              <a href="#" className="mb-5 block w-full rounded bg-retro-beige px-12 py-3 text-sm font-medium text-retro-second shadow hover:text-retro-beige hover:bg-retro-second focus:outline-none focus:ring active:text-rose-500 sm:w-auto">
                Tư Vấn
              </a>
            </div>
          </div>
