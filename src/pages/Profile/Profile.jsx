                ...
                <div className="px-6">
                    ...
                    <div className="text-center mt-12">
                        ...
                        <div className="mb-2 text-blueGray-600 mt-10">
                            <i className="fas fa-briefcase mr-2 text-lg text-blueGray-400" />Email: {userLogin.email}
                        </div>
                        <div className="mb-2 text-blueGray-600">
                            <i className="fas fa-university mr-2 text-lg text-blueGray-400" />Số điện thoại: {userLogin.soDT}
                        </div>
